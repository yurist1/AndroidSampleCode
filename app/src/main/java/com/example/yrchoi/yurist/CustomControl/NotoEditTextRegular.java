...
public class NotoEditTextRegular extends AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener {

    private Drawable clearDrawable;
    private OnFocusChangeListener onFocusChangeListener;
    private OnTouchListener onTouchListener;

    public NotoEditTextRegular(Context context) {
        super(context);
        init(context);
    }

    public NotoEditTextRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NotoEditTextRegular(Context context, AttributeSet attrs, int defStyleAttr) {
