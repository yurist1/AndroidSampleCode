...
public class NotoEditTextMedium extends AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener {

    private Drawable clearDrawable;
    private OnFocusChangeListener onFocusChangeListener;
    private OnTouchListener onTouchListener;

    public NotoEditTextMedium(Context context) {
        super(context);
        init(context);
    }

    public NotoEditTextMedium(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NotoEditTextMedium(Context context, AttributeSet attrs, int defStyleAttr) {
